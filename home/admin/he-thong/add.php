...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <form enctype="multipart/form-data" action="<?= $adminUrl?>/he-thong/save-add.php" method="post" id="formDemo" >
          ...
          <div class="col-md-12 text-right">
            <a href="<?= $adminUrl?>he-thong/brands.php" class="btn btn-xs btn-danger">Huỷ</a>
